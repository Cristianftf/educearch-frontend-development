...
const REPORT_TYPES = [
  { value: "daily", label: "Diario", description: "√öltimas 24 horas" },
  { value: "weekly", label: "Semanal", description: "√öltimos 7 dÌas" },
  { value: "monthly", label: "Mensual", description: "√öltimos 30 dÌas" },
  { value: "custom", label: "Personalizado", description: "Rango de fechas" },
]

const EXPORT_FORMATS = [
  { value: "pdf", label: "üìÑ PDF", description: "Reporte formateado con gr·ficos" },
  { value: "excel", label: "üìä Excel", description: "Tabla con filtros y an·lisis" },
  { value: "json", label: "üìã JSON", description: "Datos sin procesar" },
]
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Generar Reporte de AuditorÌa</DialogTitle>
          <DialogDescription>
            Exporta logs de auditorÌa en el formato que necesites
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            <Label className="text-base font-semibold">Formato de ExportaciÛn</Label>
              ...
              <div>
                ...
                <Select value={logLevel} onValueChange={(v: any) => setLogLevel(v)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="WARN">‚ö†Ô∏è Advertencia</SelectItem>
            ...
            <Alert className="border-green-200 bg-green-50">
              ...
              <AlertDescription className="text-green-800">
                <div className="space-y-2">
                  <div className="font-medium">‚úÖ Reporte generado exitosamente</div>
                  <div className="text-sm">
                    <div><strong>Archivo:</strong> {result.fileName}</div>
                    <div><strong>TamaÒo:</strong> {formatFileSize(result.size)}</div>
